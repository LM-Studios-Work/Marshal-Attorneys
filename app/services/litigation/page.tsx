...
export const metadata: Metadata = {
  ...
  description:
    "Civil litigation in the High Court and Magistrates' Courts — including RAF claims, unlawful arrest and constitutional litigation, debt recovery and insolvency.",
}
        ...
        <ServiceDetails
          ...
          items={[
            ...
            },
            {
              ...
              desc: "Rapid-response applications for urgent relief — interim and final interdicts, anti-dissipation orders and mandamus applications — prepared to Court Rule standards under tight deadlines.",
            },
            {
              icon: Briefcase,
